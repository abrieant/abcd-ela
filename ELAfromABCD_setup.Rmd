...
'/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/'
...
mh_y_le= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/mental-health/mh_y_le.csv", header = TRUE, stringsAsFactors = FALSE)
...
#One of the parents/caregivers went to jail?	1 = Yes; 0 = No
#Did this happen in the past year?	1 = Yes; 0 = No
mh_p_le= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/mental-health/mh_p_le.csv", header = TRUE, stringsAsFactors = FALSE)
...
mh_p_ksads_ptsd= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/mental-health/mh_p_ksads_ptsd.csv", header = TRUE, stringsAsFactors = FALSE)
...
ce_y_fes= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/culture-environment/ce_y_fes.csv", header = TRUE, stringsAsFactors = FALSE)
...
ce_y_crpbi= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/culture-environment/ce_y_crpbi.csv", header = TRUE, stringsAsFactors = FALSE)
...
abcd_p_demo= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/abcd-general/abcd_p_demo.csv", header = TRUE, stringsAsFactors = FALSE)
...
#parent report
ce_p_nsc= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/culture-environment/ce_p_nsc.csv", header = TRUE, stringsAsFactors = FALSE)
...
ce_y_nsc= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/culture-environment/ce_y_nsc.csv", header = TRUE, stringsAsFactors = FALSE)
...
mh_p_asr= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/mental-health/mh_p_asr.csv", header = TRUE, stringsAsFactors = FALSE)
...
mh_p_fhx= read.csv("/Users/ab3377/Library/CloudStorage/OneDrive-UniversityofVermont/OneDrive/FERN Lab/abcd-data-release-5.1/core/mental-health/mh_p_fhx.csv", header = TRUE, stringsAsFactors = FALSE)
